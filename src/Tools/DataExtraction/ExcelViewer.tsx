            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4 px-2 sm:px-4 py-2 sm:py-3 bg-white rounded-t-lg border-b border-gray-200">
              ...
              >
                ...
                <input
                  ...
                  className={`transition-all duration-300 ease-in-out border border-gray-300 rounded-md px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 shadow-sm
                    ${isSearchOpen || globalFilter
                      ? "w-32 sm:w-48 opacity-100 ml-1 sm:ml-2"
